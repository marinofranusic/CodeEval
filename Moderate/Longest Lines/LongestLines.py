...
#argument. The file contains multiple lines. The first line 
#indicates the number of lines you should output, the other 
#lines are of different length and are presented randomly. 
  ...
  for line in lines:
      if br==0:
          ...
          if line!="":
             dic[line]=len(line)
      br+=1
  dic_s=sorted(dic,key=dic.get,reverse=True)
